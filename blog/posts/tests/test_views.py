...
class TestPosts(TestCase):
    ...
    def test_index_page_context_is_correct(self):
        ...
        self.assertIn(response.context['page'], response.context['page'])
    ...
    def test_used_templates_is_correct(self):
        ...
        # TestPosts.post.delete()
        print(Post.objects.all())
        Post.objects.filter(pk=TestPosts.post.pk).delete()
        # TestPosts.post.delete()
        print(Post.objects.all())
    ...
    def test_paginator_in_pages_with_posts(self):
        ...
        for page, count in pages:
            ...
            print(response.context.get('page').object_list[0])
            self.assertEqual(
